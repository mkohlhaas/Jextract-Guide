...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        magick_wand_h.C_INT.withName("__readers"),
        magick_wand_h.C_INT.withName("__writers"),
        magick_wand_h.C_INT.withName("__wrphase_futex"),
        magick_wand_h.C_INT.withName("__writers_futex"),
        magick_wand_h.C_INT.withName("__pad3"),
        magick_wand_h.C_INT.withName("__pad4"),
        magick_wand_h.C_INT.withName("__cur_writer"),
        magick_wand_h.C_INT.withName("__shared"),
        magick_wand_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, magick_wand_h.C_CHAR).withName("__pad1"),
        magick_wand_h.C_LONG.withName("__pad2"),
        magick_wand_h.C_INT.withName("__flags"),
