...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        magick_wand_h.C_POINTER.withName("fptr"),
        magick_wand_h.C_POINTER.withName("rptr"),
        magick_wand_h.C_POINTER.withName("state"),
        magick_wand_h.C_INT.withName("rand_type"),
        magick_wand_h.C_INT.withName("rand_deg"),
        magick_wand_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        magick_wand_h.C_POINTER.withName("end_ptr")
