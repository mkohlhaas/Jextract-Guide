...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, magick_wand_h.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, magick_wand_h.C_SHORT).withName("__old_x"),
        magick_wand_h.C_SHORT.withName("__c"),
        magick_wand_h.C_SHORT.withName("__init"),
        magick_wand_h.C_LONG_LONG.withName("__a")
